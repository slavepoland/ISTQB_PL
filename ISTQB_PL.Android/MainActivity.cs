...
namespace ISTQB_PL.Droid
{
    ...
    public class MainActivity : FormsAppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            //MobileAds.Initialize(ApplicationContext); //"ca-app-pub-6479256761216523~3144468275"
            CrossMTAdmob.Current.Init(this, "ca-app-pub-6479256761216523~3144468275");
        ...
        public void NotifyOrientationChanged(bool isPortrait)
        {
            // Wywołaj zdarzenie zmiany orientacji na poziomie Xamarin.Forms
            MessagingCenter.Send(this, "OrientationChanged", isPortrait);
        }
